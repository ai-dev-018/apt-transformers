...
class LuminaVlm1ForCausalLM(metaclass=DummyObject):
    _backends = ["torch"]
...
class LuminaVlm1ForSequenceClassification(metaclass=DummyObject):
    _backends = ["torch"]
...
class LuminaVlm1Model(metaclass=DummyObject):
    _backends = ["torch"]
...
class LuminaVlm1PreTrainedModel(metaclass=DummyObject):
    _backends = ["torch"]
...
class LuminaForCausalLM(metaclass=DummyObject):
    _backends = ["torch"]
...
class LuminaForSequenceClassification(metaclass=DummyObject):
    _backends = ["torch"]
...
class LuminaModel(metaclass=DummyObject):
    _backends = ["torch"]
...
class LuminaPreTrainedModel(metaclass=DummyObject):
    _backends = ["torch"]
